...
# garbage-collector. Mit gc.mem_free() sieht man sehr gut, wie schnell der freie Speicher verschwindet. Daher nach der
# Installation von mem_free, gc.collect() laufen lassen. Der freie Speicherplatz bleibt erhalten
...
def show_memory():
    ...
    oled.text("Freier Speicher: ", 0, 36)
    oled.text(str(free_memory), 0, 44)
    oled.show()
